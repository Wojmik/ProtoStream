...
{
	/// <summary>
	/// Serializer for enum fields based on short, serialized as VarInt
	/// </summary>
	public class ShortEnumSerializer<TEnum> : EnumSerializerBase<TEnum>
	{
		/// <summary>
		...
		{
			return (TEnum)(object)(short)value;
		}
	}
}