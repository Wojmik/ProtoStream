...
{
	/// <summary>
	/// Serializer for enum fields based on ushort, serialized as VarInt
	/// </summary>
	public class UShortEnumSerializer<TEnum> : EnumSerializerBase<TEnum>
	{
		/// <summary>
		...
		{
			return (TEnum)(object)(ushort)value;
		}
	}
}