...
{
	/// <summary>
	/// Serializer for enum fields based on sbyte, serialized as VarInt
	/// </summary>
	public class SByteEnumSerializer<TEnum> : EnumSerializerBase<TEnum>
	{
		/// <summary>
		...
		{
			return (TEnum)(object)(sbyte)value;
		}
	}
}