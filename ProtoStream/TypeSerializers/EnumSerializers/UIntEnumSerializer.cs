...
{
	/// <summary>
	/// Serializer for enum fields based on uint, serialized as VarInt
	/// </summary>
	public class UIntEnumSerializer<TEnum> : EnumSerializerBase<TEnum>
	{
		/// <summary>
		...
		{
			return (TEnum)(object)(uint)value;
		}
	}
}