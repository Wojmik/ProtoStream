...
namespace ProtoStream.TypeSerializers
{
	...
	/// </summary>
	public class VarULongSerializer : ULongSerializerBase
	{
		/// <summary>
		/// Default instance of serializer
		/// </summary>
		public static VarULongSerializer Default { get; } = new VarULongSerializer();
		...
		{
			return await reader.ReadVarUIntWithSizeAsync(cancellationToken: cancellationToken)
				.ConfigureAwait(false);
		}
	}
}